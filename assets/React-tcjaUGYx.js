import{j as e,M as s}from"./blocks-gqGYpk7g.js";import{useMDXComponents as r}from"./index-De36GQbW.js";import"./iframe-BBoZTpeG.js";import"./index-BFVZ7Xg9.js";import"./_commonjsHelpers-CqkleIqs.js";function o(n){const t={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",p:"p",pre:"pre",strong:"strong",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Frameworks/React"}),`
`,e.jsx(t.h1,{id:"react",children:"React"}),`
`,e.jsxs(t.p,{children:[`Direct support for custom elements in React has been a requested feature for long time. As you can see on\r
...
`,e.jsx(t.p,{children:`React doesn't pass data through the JavaScript API on HTML elements. This means that any Web Components created\r
with the Custom Elements API in the browser will suffer from the same issue when trying to pass complex data types\r
such as array, objects, and functions through to the underlying HTML element.`}),`
`,e.jsx(t.p,{children:`Another issue is how event bubbling works in React. Since React uses its own synthetic events system, standard HTML\r
...
`,e.jsx(t.p,{children:`This adapter library provides a thin wrapper component around all Forge Extended components that allows you to pass data and listen\r
...
`,e.jsxs(t.p,{children:["To use Forge Extended components in your React application, import the components you need from the ",e.jsx(t.code,{children:"@tylertech/forge-extended-react"}),` package,\r
as well as the custom elements from `,e.jsx(t.code,{children:"@tylertech/forge-extended"}),"."]}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-jsx",children:`import { ForgeResponsiveToolbar } from '@tylertech/forge-extended-react';\r
\r
import '@tylertech/forge-extended/responsive-toolbar';\r
\r
function App() {\r
  return <ForgeResponsiveToolbar></ForgeResponsiveToolbar>;\r
}
