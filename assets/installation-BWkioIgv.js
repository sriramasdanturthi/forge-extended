import{j as e,M as i}from"./blocks-gqGYpk7g.js";import{useMDXComponents as o}from"./index-De36GQbW.js";import"./iframe-BBoZTpeG.js";import"./index-BFVZ7Xg9.js";import"./_commonjsHelpers-CqkleIqs.js";function t(r){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Getting Started/Installation"}),`
`,e.jsx(n.h1,{id:"installation",children:"Installation"}),`
`,e.jsx(n.p,{children:`To get started, install both the core Tyler Forge library and the extended library (if the core library is already installed,\r
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"@tylertech/forge"}),` library is a peer dependency of the extended library, and they are very tightly coupled and intended\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import '@tylertech/forge-extended/busy-indicator';\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import { defineBusyIndicatorComponent } from '@tylertech/forge-extended';\r
\r
defineBusyIndicatorComponent();
`})}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note:"}),` make sure to import the components or definition functions as early as possible in your application bootstrapping\r
