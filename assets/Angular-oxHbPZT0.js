...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { ForgeResponsiveToolbarModule } from '@tylertech/forge-extended-angular';\r
\r
@NgModule({\r
  imports: [ForgeResponsiveToolbarModule]\r
})\r
export class MyModule {}
`})}),`
`,e.jsx(n.p,{children:"With standalone Angular components:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { ForgeButtonModule } from '@tylertech/forge-extended-angular';\r
\r
@Component({\r
  selector: 'app-my-component',\r
  template: '<forge-responsive-toolbar></forge-responsive-toolbar>',\r
  imports: [ForgeResponsiveToolbarModule]\r
})\r
export class MyComponent {}
`})}),`
`,e.jsx(n.h2,{id:"custom_elements_schema",children:"CUSTOM_ELEMENTS_SCHEMA"}),`
`,e.jsxs(n.p,{children:[`While not recommended, if you prefer not to use the adapter, you can easily disable the Angular compiler from throwing errors by adding the\r
`,e.jsx(n.code,{children:"CUSTOM_ELEMENTS_SCHEMA"})," to your component or module's ",e.jsx(n.code,{children:"schemas"})," array:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';\r
\r
@NgModule({\r
...
`})}),`
`,e.jsx(n.p,{children:`This is a quicker and easier way to get started with Forge Extended components in your Angular application, but keep in mind that you will lose some of the\r
type safety and integration benefits that the adapter provides.`}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[`If you're interested in pushing the Angular team along to help improve the support for custom elements, please consider up voting or chiming in on\r
